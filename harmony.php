<?php
	...
	i18n_merge('harmony') || i18n_merge('harmony', 'en_US');
	...
	register_plugin(
		...
		i18n_r('harmony/LANG_Description'), //Plugin description
	...
	# add a link in sidebar
	add_action('pages-sidebar','createSideMenu',array($thisfile,i18n_r('harmony/LANG_Settings'). ' 🪗'));
	...
	function harmonyOptions() {
		...
		<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank" style="box-sizing:border-box; display:grid; width:100%; grid-template-columns:1fr auto; padding:10px; background:#fafafa; border:solid 1px #ddd; margin-top:20px;">
			<p style="margin:0;padding:0;"> '. i18n_r('harmony/LANG_PayPal').' </p>
